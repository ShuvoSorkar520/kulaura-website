  ...
  return <section id="contact" className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700">আমাদের সাথে যোগাযোগ করতে নিচের ফর্মটি পূরণ করুন বা ইমেইল করুন</p>
        </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-md p-8">
                ...
                field
                      ...
                      <FormControl>
                        <input {...field} className="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <input {...field} type="email" className="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
                ...
                field
                      ...
                      <FormControl>
                        <Textarea {...field} rows={4} className="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />
            ...
            <div className="bg-white rounded-xl shadow-md p-8 h-full">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700">অফিসিয়াল ভাবে কুনো অফিস ওপেন করা হয়নি</p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-gray-700">+8801700586356</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Mail size={18} className="text-primary" />
                    <span className="text-gray-700">kulaurahub01@gmail.com</span>
                  </div>
                </div>
